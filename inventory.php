    ...
    <main class="container">
        <div class="search-section">
            ...
            <form method="get" class="search-form">
                <input type="text" name="search" style="border-radius:10px;border:1px solid grey;" placeholder="Search Medicine" value="<?= isset($_GET['search']) ? htmlspecialchars($_GET['search']) : '' ?>">
