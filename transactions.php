            ...
            <thead>
                <tr style='background-color: #4CAF50; color: white;'>
                    ...
                    foreach ($transactions as $transaction): 
                        ...
                        echo "<td>" . htmlspecialchars($transaction->doctor_name) . "</td>";
                        echo "<td>" . htmlspecialchars($transaction->timestamp) . "</td>"; // Format timestamp
                        echo "<td><button type='submit' name='finalize_bill' class='button'>Print Bill</button></td>";
                        echo "</tr>"; 
